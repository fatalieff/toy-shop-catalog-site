    ...
    <>
      ...
      <header className="flex justify-between items-center w-full p-12">
        <div className="relative w-64">
          ...
          <input
            type="text"
            placeholder="Search"
            className="w-full bg-[#EAC7C6] text-[#fff] placeholder:text-[#fff] pl-10 pr-4 py-4 rounded-full text-sm focus:outline-none focus:ring-1 focus:ring-[#5C3D3D]"
          />
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center px-12 pb-12">
        <div className="space-y-6 max-w-xl">
          ...
          <p className="text-[#8A6F6F] text-sm leading-relaxed">
          ...
          <Link href="/shop" className="inline-block text-white font-bold px-8 py-3 rounded-full shadow-lg hover:shadow-xl transition-all duration-300" style={{ background: "linear-gradient(180deg, #DC8F95 0%, #CB655B 100%)" }}>
            Order Now
          </Link>
        </div>
      </div>
