    ...
    <section className="p-10 sm:p-14">
      <div className="max-w-5xl mx-auto bg-white/90 rounded-[36px] border border-[#f1d4d4] shadow-[0_30px_80px_rgba(92,61,61,0.12)] overflow-hidden page-hero-float">
        <div className="p-10 lg:p-14">
          ...
          <h1 className="text-5xl LuckiestGuy text-[#5C3D3D] mt-4 page-stagger-1">Welcome to ToyWorld</h1>
          <p className="mt-6 text-[#8A6F6F] leading-8 text-lg page-stagger-2">
          ...
          <div className="mt-10 rounded-[32px] bg-[#F9E6E6] p-8 text-[#5C3D3D] shadow-sm page-stagger-3">
